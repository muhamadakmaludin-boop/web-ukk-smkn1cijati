...
<head>
    ...
    <title>Tambah Berita - Admin SMKN 1 CIJATI</title>
...
<div class="admin-wrapper">
    ...
    <div class="admin-content">
        ...
        <header class="admin-topbar">
            ...
            <div>
                <h1>Tambah Berita</h1>
                <p>Isi form berikut untuk menambahkan berita atau kegiatan baru</p>
            </div>
        ...
        <main class="admin-main">
            ...
            <section class="admin-section">
                ...
                <div class="admin-form-wrap">
                    <form action="{{ url('/admin/berita') }}" method="POST" enctype="multipart/form-data" class="admin-form">
                        @csrf

                        <div class="admin-field">
                            <label for="judul">Judul Berita</label>
                            <input type="text" name="judul" id="judul" value="{{ old('judul') }}" placeholder="Contoh: Upacara HUT RI">
                        </div>
                        ...
                        <div class="admin-field-row">
                            ...
                            <div class="admin-field">
                                ...
                                <select name="tag" id="tag">
                                    ...
                                    <option value="Siswa" {{ old('tag') == 'Siswa' ? 'selected' : '' }}>Siswa</option>
                                    <option value="Prestasi" {{ old('tag') == 'Prestasi' ? 'selected' : '' }}>Prestasi</option>
                                    <option value="Pengumuman" {{ old('tag') == 'Pengumuman' ? 'selected' : '' }}>Pengumuman</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="admin-field">
                            ...
                            <textarea name="ringkasan" id="ringkasan" rows="5" placeholder="Tuliskan isi atau ringkasan berita di sini">{{ old('ringkasan') }}</textarea>
                        </div>
                        ...
                        <div class="admin-form-actions">
                            <button type="submit" class="admin-btn">Simpan Berita</button>
